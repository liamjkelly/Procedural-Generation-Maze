...
public class Pathmaker : MonoBehaviour {
	...
	public Transform floorPrefab1, floorPrefab2, floorPrefab3; //assign Tile to this in inspector
	public Transform pathmakerSpherePrefab; //assign in in inspector
	public static int globalTileCount; //prevents building over a certain number tiles
	...
	int prefabStyle; //number corresponds to style of prefab to be used
	...
	void Update () {
		if (counter < pathmakerLife) {
			...
			prefabStyle = Random.Range (1, 4); //generates random number betwen 1 and 3 corresponding to style
